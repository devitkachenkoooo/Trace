...
export default async function Home() {
  ...
  // If authenticated, show welcome message with user info
  // In the future, this will show actual chats from the database
  return (
    <div className="max-w-3xl mx-auto py-10 px-4">
      ...
      <div className="flex flex-col items-center justify-center min-h-[300px] text-center px-4 bg-white/5 rounded-2xl border border-white/5">
        <h2 className="text-2xl font-bold text-gray-200 mb-2">No chats yet</h2>
        <p className="text-gray-400">Start a new conversation to get started</p>
      </div>
    </div>
  );
}
